...
if __name__ == "__main__":
    ...
    NUM_RECORDS_A = 100_00
    NUM_RECORDS_B = 80_00    
    NUM_RECORDS_C = 60_00  
    NUM_RECORDS_D = 50_00  
    
    # 1. 生成数据
    tA, tB, tC, tD = generate_4way_same_key_tables(
        DOMAIN_SIZE, NUM_RECORDS_A, NUM_RECORDS_B, NUM_RECORDS_C, NUM_RECORDS_D
    )
    
    # 2. 运行 4-Way Pipelined Join
    run_4way_same_key_pipelined(
        tA, tB, tC, tD, 
        D=DOMAIN_SIZE, 
        eps_total=1.0, 
        delta_total=1e-6
